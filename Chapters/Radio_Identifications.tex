...
Table \ref{tab:smg_coverage} shows the coverage of the observations in the COSMOS field provided by COSMOS2020. 
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\columnwidth]{Figures/smg_colours.pdf}
	\caption{{\color{red} Caption.}}
