...
\begin{table}
    ...
    \begin{tabular}{p{2.5cm}|p{2.5cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}}
        \hline
        \hline
        Method & Redshift Range & log($\phi^*$) & log($M^*$) & $\alpha$ & $\rho_{\textrm{dust}}$ \\
        \hline
        \hline
        \multirow{5}{*}{$\phi_{\textrm{est, T=20\,K}}$} & 0 < z < 0.2 & 888$\pm$888 & 888 & -1.22 & 888 \\
        & 0.2 < z < 0.4 & 888 & 888 & -1.22 & 888 \\
        & 0.4 < z < 0.6 & 888 & 888 & -1.22 & 888 \\
        & 0.6 < z < 0.8 & 888 & 888 & -1.22 & 888 \\
        & 0.8 < z < 1 & 888 & 888 & -1.22 & 888 \\
        \hline
        \multirow{5}{*}{$\phi_{\textrm{est, Dunne}}$} & 0 < z < 0.2 & 888 & 888 & -1.22 & 888 \\
        & 0.2 < z < 0.4 & 888 & 888 & -1.22 & 888 \\
        & 0.4 < z < 0.6 & 888 & 888 & -1.22 & 888 \\
        & 0.6 < z < 0.8 & 888 & 888 & -1.22 & 888 \\
        & 0.8 < z < 1 & 888 & 888 & -1.22 & 888 \\
