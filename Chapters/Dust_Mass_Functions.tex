...
\begin{table}
    ...
    \begin{tabular}{p{2.5cm}|p{2.5cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}}
        \hline
        \hline
        Method & Redshift Range & log($M^*$) & log($\phi^*$) & $\alpha$ & $\rho_{\textrm{dust}} [\times10^5]$ \\
        \hline
        \hline
