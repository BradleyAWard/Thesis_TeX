...
Interstellar dust is responsible for obscuring approximately half of all starlight since the Big Bang (\citealt{Puget_1996}; \citealt{Fixsen_1998}; \citealt{Dole_2006}; \citealt{Driver_2016}). Young, massive OB stars produce the UV photons that heat the interstellar dust, getting absorbed and reradiated to far-IR wavelengths (\citealt{Kennicutt_1998}; \citealt{Calzetti_2007}; \citealt{Kennicutt_2009}), thus the measurement of extragalactic dust masses are useful in our understanding of obscured star formation at different times in cosmic history. In order to study the evolution in the star formation history of the Universe, the most direct method is to measure the mass of the galaxies' molecular gas from which the stars form and then estimate the star formation activity from the evolution of the cosmic molecular gas mass density. As will be detailed in the subsequent Chapter, molecular hydrogen, $H_2$ (the main component of the molecular gas in a galaxy), cannot be easily observed at the temperatures of the cold ISM ($\sim$ 15 -- 25\,K), whereas dust emission provides a suitable alternative at these temperatures. Using an independent measure of the cosmic gas mass density from dust-traced gas mass (assuming some gas-to-dust mass ratio) allows us to constrain both the dust content of galaxies and their contribution to obscured star formation over time. In addition, metals are produced and expelled by supernovae and stellar winds, with some fraction becoming bound to dust grains in the ISM. As a result, the total dust mass is also a fundamental property of the ISM that can be used to trace the evolutionary stage of the galaxy (e.g. \citealt{Cortese_2012}; \citealt{deVis_2017a}; \citealt{deVis_2017b}).

For these reasons, studying the distribution of dust masses for a population of galaxies across time can provide important insights into the properties and evolution of galaxies and their ISM. The dust mass function (DMF), the space density of galaxies as a function of dust mass, is a fundamental measure of the dust content of galaxies, providing crucial information on galaxy evolution, star formation activity and the cosmic dust budget. In this work, we use the results of the crossmatching analysis of the South Galactic Pole field of the \textit{Herschel}-ATLAS, as presented in the previous Chapter, to derive the far-IR selected DMF and investigate whether it has evolved with redshift from the local universe to z $\sim$ 1.
...
As mentioned earlier, estimating dust masses from sub-mm photometry is advantageous as the Rayleigh-Jeans (R-J) part of the Planck function is least sensitive to dust temperature and most sensitive to dust mass. In the R-J regime ($\lambda_{\textrm{rest}} \gg \frac{hc}{kT}$) the Planck function reduces to $B(\nu_{250}, T) = \frac{2\nu_{250}^{2}kT}{c^2}$ which means that in the optically thin and R-J regimes our dust mass estimates are only linearly dependent on the dust temperature. {\color{red} Comparison of 250 and 350um - use "wavelength selection" section in notes.}
