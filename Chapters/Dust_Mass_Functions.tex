...
Figure \ref{fig:dmf_schechter} shows the best fit Schechter functions to our $\phi_{\textrm{est, T=20\,K}}$ (solid lines, filled circles) and $\phi_{\textrm{est, Dunne}}$ (dashed lines, open circles) DMFs. The fitting parameters are listed in Table \ref{tab:schechter_parameters}.
